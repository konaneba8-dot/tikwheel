  ...
  return [
    {
      ...
      accountName: 'TikWheel Demo Account',
    ...
    promotionCampaigns: [
      {
        ...
        gameTypeId: gameTypes[0]?.id || 'gt_demo',
        ...
        shares: [
          { id: 'share_demo_1', campaignId: 'cmp_demo_1', scheduledFor: new Date(Date.now() - 30 * 60 * 1000).toISOString(), status: 'completed', channel: 'manual-approval-queue', workflow: 'manual-review', message: 'Approved for manual approval queue', errorLog: null, createdAt: now(), updatedAt: now() },
          { id: 'share_demo_2', campaignId: 'cmp_demo_1', scheduledFor: new Date(Date.now() - 15 * 60 * 1000).toISOString(), status: 'failed', channel: 'manual-approval-queue', workflow: 'manual-review', message: 'Blocked by approval hold', errorLog: 'Manual approval rejected by reviewer', createdAt: now(), updatedAt: now() },
        ],
      },
    ],
    promotionLogs: [
      { id: 'log_demo_1', campaignId: 'cmp_demo_1', shareId: 'share_demo_1', status: 'completed', message: 'Approved for manual approval queue', channel: 'manual-approval-queue', workflow: 'manual-review', createdAt: now() },
      { id: 'log_demo_2', campaignId: 'cmp_demo_1', shareId: 'share_demo_2', status: 'failed', message: 'Blocked by approval hold', channel: 'manual-approval-queue', workflow: 'manual-review', errorLog: 'Manual approval rejected by reviewer', createdAt: now() },
    ],
  };
}
